...
public class RideObject {
    ...
    public void parseData(DataSnapshot dataSnapshot){
        ...
        destinatiodos = new LocationObject();
        ...
        if(dataSnapshot.child("destinationdos").child("name").getValue()!=null){
            destinatiodos.setName(dataSnapshot.child("destinationdos").child("name").getValue().toString());
        }
        ...
        } if(dataSnapshot.child("destinationdos").child("lat").getValue()!=null && dataSnapshot.child("destinationdos").child("lng").getValue()!=null){
            destination.setCoordinates(
                    new LatLng(Double.parseDouble(dataSnapshot.child("destinationdos").child("lat").getValue().toString()),
                            Double.parseDouble(dataSnapshot.child("destinationdos").child("lng").getValue().toString())));
        }
    ...
    public void postRideInfo(){
        ...
        map.put("destinationdos/name", destinatiodos.getName());
        map.put("destinationdos/lat", destinatiodos.getCoordinates().latitude);
        map.put("destinationdos/lng", destinatiodos.getCoordinates().longitude);
    ...
    public LocationObject getDestinationdos() {
        return destinatiodos;
    }
    public void setDestinationdos(LocationObject destinatiodos) {
        this.destinatiodos = destinatiodos;
    }
